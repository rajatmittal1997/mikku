...
const Success = () => (
  <div className="App-success">
    ...
    <p className="App-text-success">
      You're my favorite person , my princess, and the one I enjoy every
      moment with.
    </p>
    <p className="App-text-success">
      Looking forward to spending Valentine's Day with you, My Mikku.
    </p>
    {/* Displaying the date of the special moment */}
    <p className="App-text-date">14/02/2026</p>
  </div>
);
